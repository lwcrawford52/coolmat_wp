...
<!-- intro section -->
<!-- query for intro custom post type -->


	<?php query_posts('posts_per_page=1&post_type=intros'); ?>
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	...
	<!-- pulling category name for heading -->
	...
	<div class="section-heading" id="locations">
		<?php get_category_description('post_type=locations'); ?>
	
	</div>
	<div class="locations">
		<!-- query for locations post type -->
